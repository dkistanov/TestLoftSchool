...
"use strict";$(".main__check").on("click",function(){$(".highlighting__num").text($(".main__checkbox:checked").length)}),$(".main__highlighting-right").on("click",function(){$(".main__checkbox:checked").closest(".main__item").remove(),$(".highlighting__num").text($(".main__checkbox:checked").length),totalPrice()}),$(".price").each(function(){$(this).parent().next().next().children(".final-price").text(parseInt($(this).text(),10)*$(this).parent().next($("main__good-quantity")).val())}),$(document).on("keyup",function(){totalPrice(),modalPrice(),$(".price").each(function(){$(this).parent().next().next().children(".final-price").text(parseInt($(this).text(),10)*$(this).parent().next($("main__good-quantity")).val())})});for(var inp=document.querySelectorAll(".modal__quantity"),i=0;i<inp.length;i++)inp[i].addEventListener("keydown",function(t){var e=!1,i=!1;(t.key>=0||t.key<=9)&&(e=!0),"ArrowLeft"!=t.key&&"ArrowRight"!=t.key&&"Backspace"!=t.key||(i=!0),0==i&&0==e&&t.preventDefault()});function modalPrice(){$(".modal__final-price").each(function(){$(this).children(".final-price_modal").text(parseInt($(this).prev().prev().prev().prev().children(".price_num_modal").text(),10)*$(this).prev().prev().val())})}function totalPrice(){var t=0;$(".final-price").each(function(e,i){t+=parseInt($(i).text(),10)}),$(".total_price").children(".total_price_num").text(t);var e;e=Math.round(parseInt($(".total_price_num").text(),10)/100*18),$(".vat_num").text(e),$(".bold_total").text(t+e+" Р")}$(".main__good-quantity").on("click",function(t){$(this).parent().next().css("display","block")}),$(".button.exit").on("click",function(){$(this).closest(".modal-wrap").css("display","none")}),$(document).mouseup(function(t){modalPrice(),totalPrice();var e=$(".modal-wrap");0===e.has(t.target).length&&e.css("display","none")}),$(".modal__price").each(function(){$(this).children(".price_num_modal").text($(this).closest(".main__item").children(".main__good-price__wrap").children(".main__good-price").children(".price").text())}),modalPrice(),$(".minus").on("click",function(){var t=$(this).next(),e=parseInt(t.val())-1;e=e<1?1:e,t.val(e),t.change(),modalPrice()}),$(".plus").on("click",function(){var t=$(this).prev();t.val(parseInt(t.val())+1),t.change(),modalPrice()}),$(".button.save").on("click",function(){$(this).closest(".modal-wrap").prev().children(".main__good-quantity").val($(this).closest(".modal").children(".modal__calc").children(".main__good-quantity.modal__quantity").val()),$(this).closest(".modal-wrap").prev().children(".main__good-final-price").children(".final-price").text($(this).closest(".modal").children(".modal__calc").children(".modal__final-price").children(".final-price_modal").text()),totalPrice(),$(this).closest(".modal-wrap").css("display","none")}),totalPrice(),$(".main__numbering").each(function(t){$(this).text(++t)});